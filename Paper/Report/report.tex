...
Neural networks are currently among the most widely used models in machine
learning. A sub-category of these, known as convolutional neural networks, is
primarily applied to image recognition tasks. By using pooling and convolution
layers, CNNs can extract features from images, making them effective for image
classification. They have been showing promising results when compared to
classical methods. This project explores the integration of quantum computing
...
\caption{Accuracy and final loss of the synthetic tests}
\end{table}
