...
plt.savefig('results/tutorial1/loss_convergence_no_evolution.png')

# Save model
torch.save(model.state_dict(), "models/model_no_evolution.pt")

# Load and evaluate
qnn_test = create_qnn()
model_test = HybridNet(qnn_test)
model_test.load_state_dict(torch.load("models/model_no_evolution.pt"))
model_test.eval()
