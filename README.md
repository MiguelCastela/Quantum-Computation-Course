...
Final paper and poster for the **Curso de Formação Especializada em Computação e
Tecnologias Quânticas** (QCML2) — Universidade de Coimbra.

**Author:** Miguel Castela · DEI, Universidade de Coimbra
...
| | Location |
|---|---|
| **Paper** (LaTeX source + final PDF) | [`paper/`](paper/) → [`report_final.pdf`](paper/report_final.pdf) |
| **Poster** (final + drafts) | [`poster/`](poster/) → [`poster_final.pdf`](poster/poster_final.pdf) |
| **Source code** | [`src/`](src/) |
...
- [`coursework/02-deutsch-jozsa-grover/`](coursework/02-deutsch-jozsa-grover/) — Deutsch–Jozsa & Grover implementations
...
via a local `.env` file (git-ignored — **never commit it**):
