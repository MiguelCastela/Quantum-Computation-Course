...
\subsubsection*{\fontsize{16}{20}\selectfont Trying to manually process the images using NEQR and FRQI}
...
\subsubsection*{\fontsize{16}{20}\selectfont Deciding between Adam and COBYLA}
...
\subsubsection*{\fontsize{16}{20}\selectfont Deciding between zfeaturemap and zzfeaturemap}
\addcontentsline{toc}{subsection}{Deciding between z and COBYLA}

\subsection*{\fontsize{16}{20}\selectfont Deciding the feature extraction method}
...
\subsection*{\fontsize{16}{20}\selectfont Deciding the ansatz}
...
\subsection*{\fontsize{16}{20}\selectfont The output layer}
...
\subsection*{\fontsize{16}{20}\selectfont Pooling and convolution layers}
...
\subsubsection*{\fontsize{16}{20}\selectfont Creating the custom HCQNN}
...
Reduces to 4 classical features.

Uses a quantum layer (EstimatorQNN).

Classifies using LogSoftmax.
...
\subsection*{\fontsize{16}{20}\selectfont tests}
