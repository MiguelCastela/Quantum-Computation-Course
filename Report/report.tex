...
ing the COBYLA optimizer for a maximum of 200 iterations.
...
\addplot+[mark=*, thick] coordinates {
    (10, -1.0167) (20, -0.9827) (30, -0.9599) (40, -0.9471)
    (50, -0.9377) (60, -0.9303) (70, -0.9523) (80, -0.9212)
    (90, -0.9162) (100, -0.9107)
};
\addlegendentry{Average run (63\% accuracy)}
\end{axis}
\end{tikzpicture}
...
More experimental strategies were studied, such as QPIE \cite{https://doi.org/10.1038/s41598-023-30575-2www.nature.com/scientificreports} wich is a more structure-aware encoding inspired by polar coordinates and DCT-EFRQI \cite{arXiv:2203.01831v1}, wich efficiently takes advantage of classical Discrete Cosine Transform. This would maybe yeild slightly better results but similar results to the other classical encoding methods mentioned.
...
% Without Evolutionary Operators
\addplot+[mark=triangle*, thick] coordinates {
    (1, -0.4994) (2, -0.4984) (3, -0.4988) (4, -0.4987)
    (5, -0.4990) (6, -0.4985) (7, -0.4987) (8, -0.4991)
    (9, -0.4982) (10, -0.4991)
};
\addlegendentry{Without (50.0\%)}
...
\begin{tikzpicture}
\begin{axis}[
    title={Training Progress vs. Loss (Hybrid Model)},
...
\addplot+[mark=*, thick] coordinates {
    (1, 0.6509) (2, 0.4542) (3, 0.3945) (4, 0.3158)
    (5, 0.2173) (6, 0.1842) (7, 0.1675) (8, 0.1153)
    (9, 0.1203) (10, 0.0853)
};
\addlegendentry{Hybrid 1}

\addplot+[mark=triangle*, thick] coordinates {
    (1, 0.9539) (2, 0.7315) (3, 0.5905) (4, 0.4266)
    (5, 0.3387) (6, 0.2781) (7, 0.2031) (8, 0.1564)
    (9, 0.1406) (10, 0.1181)
};
\addlegendentry{Hybrid 2}

\addplot+[mark=square*, thick] coordinates {
    (1, 0.7188) (2, 0.6535) (3, 0.6142) (4, 0.5819)
    (5, 0.5169) (6, 0.4814) (7, 0.4635) (8, 0.4058)
    (9, 0.3311) (10, 0.3057)
};
\addlegendentry{Hybrid 3}

\addplot+[mark=diamond*, thick] coordinates {
    (1, 0.6161) (2, 0.4765) (3, 0.3741) (4, 0.3459)
    (5, 0.2770) (6, 0.2196) (7, 0.2104) (8, 0.2403)
    (9, 0.1517) (10, 0.2115)
};
\addlegendentry{Hybrid 4}

\addplot+[mark=star, thick] coordinates {
    (1, 0.7009) (2, 0.6428) (3, 0.5852) (4, 0.4823)
    (5, 0.4290) (6, 0.3336) (7, 0.2732) (8, 0.2527)
    (9, 0.2094) (10, 0.1845)
};
\addlegendentry{Hybrid 5}
...
\begin{tikzpicture}
\begin{axis}[
    title={Training Progress vs. Accuracy},
    xlabel={Training Progress (\%)},
    ylabel={Accuracy (\%)},
    xmin=0, xmax=100,
    ymin=0, ymax=110,
...
\addplot+[mark=*, thick] coordinates {
    (10, 88.00) (20, 100.00) (30, 100.00) (40, 100.00)
    (50, 100.00) (60, 100.00) (70, 100.00) (80, 100.00)
    (90, 100.00) (100, 100.00)
};
\addlegendentry{Test 1}

\addplot+[mark=triangle*, thick] coordinates {
    (10, 38.00) (20, 38.00) (30, 82.00) (40, 82.00)
    (50, 100.00) (60, 100.00) (70, 100.00) (80, 100.00)
    (90, 100.00) (100, 100.00)
};
\addlegendentry{Test 2}
...
\addplot+[mark=square*, thick] coordinates {
    (10, 80.00) (20, 80.00) (30, 80.00) (40, 80.00)
    (50, 80.00) (60, 90.00) (70, 90.00) (80, 90.00)
    (90, 100.00) (100, 100.00)
};
\addlegendentry{Test 3}

\addplot+[mark=diamond*, thick] coordinates {
    (10, 88.00) (20, 100.00) (30, 92.00) (40, 96.00)
    (50, 100.00) (60, 92.00) (70, 100.00) (80, 100.00)
    (90, 100.00) (100, 100.00)
};
\addlegendentry{Test 4}

\addplot+[mark=star, thick] coordinates {
    (10, 46.00) (20, 94.00) (30, 92.00) (40, 100.00)
    (50, 100.00) (60, 100.00) (70, 100.00) (80, 100.00)
    (90, 100.00) (100, 100.00)
};
\addlegendentry{Test 5}
...
\subsection*{\fontsize{12}{16}\selectfont MNIST dataset}
\addcontentsline{toc}{subsection}{MNIST dataset}
